	...
	def findSiteKeyBoard(self, site):
		...
		while proccess:
			...
			if isInScreen:
				...
				# while attempts < 5:
				# 	sleep(1)
				# 	isInScreen, location = self.findImage(self.PATH_IMAGE+'/nextPage.png',True, .7)### find letshome
				# 	#isInScreen, location = self.findImage(self.PATH_IMAGE+'/'+'testing' + '.png',True, .8)### find testingrevimex
				# 	if isInScreen:
				# 		break
				# 	attempts = attempts + 1
				...
				# 	click(centerImage)
				# 	click(centerImage)
				# 	attemptsPages = attemptsPages + 1
				# 	sleep(2)
				# else:
				# 	attemptsPages = attemptsPages + 1
				# ################# cambiar de pagina si es posible
				# isInScreen, location = self.findImage(self.PATH_IMAGE+'/'+'siguiente' + '.png',True, .8)### find boton siguiente
				# if  isInScreen:
				# 	centerImage = location
				# 	click(centerImage)
				# 	click(centerImage)
